...
class LiveProgramGridViewPagingAdapter(private val clickListener: RecyclerViewClickListener) :
    PagingDataAdapter<LiveStreamCategory, LiveProgramGridViewPagingAdapter.ViewHolder>(
        ItemComparator
    ) {
...
//                            .into(ivProgram)
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): LiveProgramGridViewPagingAdapter.ViewHolder {
