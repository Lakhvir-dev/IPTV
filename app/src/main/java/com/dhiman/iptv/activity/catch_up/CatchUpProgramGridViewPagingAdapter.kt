...
class CatchUpProgramGridViewPagingAdapter(private val clickListener: RecyclerViewClickListener) :
    PagingDataAdapter<LiveStreamCategory, CatchUpProgramGridViewPagingAdapter.ViewHolder>(
        ItemComparator
    ) {
...
//                        .into(ivProgram)
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): CatchUpProgramGridViewPagingAdapter.ViewHolder {
